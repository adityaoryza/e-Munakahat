        ...
        <div>
            ...
            <div class="mt-4">
                ...
                <div class="flex items-center space-x-4">
                    <label>
                        <input type="radio" name="Gender" value="Male" @if(old('Gender', $user->Gender) === 'Male')
                        checked @endif>
                        <span class="ml-2">Male</span>
                    </label>
                    <label>
                        <input type="radio" name="Gender" value="Female" @if(old('Gender', $user->Gender) === 'Female')
                        checked @endif>
            ...
            <div class="mt-4">
                ...
                <x-text-input id="PhoneNum" name="PhoneNum" type="text" class="mt-1 block w-full"
                    :value="old('PhoneNum', $user->PhoneNum)" required autocomplete="PhoneNum" />
